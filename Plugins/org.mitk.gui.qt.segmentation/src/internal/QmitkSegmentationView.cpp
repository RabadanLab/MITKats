...
void QmitkSegmentationView::CreateQtPartControl(QWidget* parent)
{
   ...
   m_Controls->m_ManualToolSelectionBox3D->SetDisplayedToolGroups(tr("Threshold 'UL Threshold' Otsu 'Fast Marching 3D' 'Region Growing 3D' Watershed Picking 'Threshold Morph'").toStdString());
