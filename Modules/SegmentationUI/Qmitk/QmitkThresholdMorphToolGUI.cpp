...
{
  m_RegionGrow3DTool = dynamic_cast<mitk::ThresholdMorphTool *>(tool);
...
void QmitkThresholdMorphToolGUI::RunSegmentation()
{
  ...
  if (node.IsNull())
  {
    QMessageBox::information(NULL, "Adaptive Region Growing functionality", "Please insert a seed point inside the "
  ...
  if (seedPointSet.IsNull())
  {
    ...
    QMessageBox::information(
      NULL, "Adaptive Region Growing functionality", "The seed point is empty! Please choose a new seed point.");
    return;
  }
  ...
  if (orgImage.IsNotNull())
  {
    ...
    else
    {
      QApplication::restoreOverrideCursor(); // reset cursor
      QMessageBox::information(
        NULL, "Adaptive Region Growing functionality", "Only images of dimension 3 or 4 can be processed!");
      return;
    }
  }
...
void QmitkThresholdMorphToolGUI::StartRegionGrowing(itk::Image<TPixel, VImageDimension> *itkImage,
...
void QmitkThresholdMorphToolGUI::InitializeLevelWindow()
{
...
void QmitkThresholdMorphToolGUI::ChangeLevelWindow(double newValue)
{
...
void QmitkThresholdMorphToolGUI::DecreaseSlider()
{
...
void QmitkThresholdMorphToolGUI::IncreaseSlider()
{
...
template <typename TPixel, unsigned int VImageDimension>
void QmitkThresholdMorphToolGUI::ITKThresholding(itk::Image<TPixel, VImageDimension> *itkImage)
{
